...
<body>
 ...
 <nav class="navigation" style="background-color: #2DDB2D;" role="navigation">
  ...
  <ul id='dropdown1' class='dropdown-content' style="background-color: #2DDB2D;">
    ...
    <li><a href="servicios.php" style="color: #ffffff">AGRÃ�COLA</a></li>
    <!--
    <li class="divider"></li>
    <li><a href="servicios.php" style="color: #ffffff">OTROS</a></li>-->
      ...
      <ul class="dropdown-content" id="comp-menu3">
        ...
        <li><a href="servicios.php">ERNC</a></li>
          ...
          <li><a href="servicios.php">AGRÃ�COLA</a></li>
      </ul>
      ...
      <ul class="right hide-on-med-and-down">
        ...
        <li><a href="ingenieria.php">IngenierÃ­a</a></li>
  ...
  <div class="container">
    ...
    <h3 class="center-align" style="color: #25D366;">CONTACTO</h3>
      <article class="offset-s3">
        ...
        <form role="form" method="POST" action="correo.php" enctype="multipart/form-data">
          ...
          <div class="input-field">
            ...
            <label for="number" style="color: #25D366;">TelÃ©fono</label>
...
<footer class="page-footer" style="background-color: #2DDB2D;">
 ...
 <div class="col s5 m5 left-align">
      <b>Todos los derechos reservados a </b><a class="grey-text text-darken-4" href="index.php"><br><b>AutoEnergy IngenierÃ­a y Servicios SPA</b></a> </div>
